<%@page import="com.Revshop.entities.Message"%>
<%@page import="com.Revshop.dao.UserDao"%>
<%@page errorPage="error_exception.jsp"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
<%@page import="com.Revshop.entities.OrderedProduct"%>
<%@page import="com.Revshop.entities.Order"%>
<%@page import="java.util.List"%>
<%@page import="com.Revshop.dao.OrderedProductDao"%>
