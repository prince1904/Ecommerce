...
<body>
						...
						<div class="card cus-card h-100">
							<div class="container text-center">
								<img src="Product_imgs\<%=c.getCategoryImage()%>" class="mt-3 "
									style="max-width: 155px; max-height: 100vh; width: auto; height: auto;border-radius:700%">
							</div>
	...
	<div id="carouselAutoplaying"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="Images/scroll_img2.png" class="d-block w-100" alt="..." style="height:70vh">
			</div>
			<div class="carousel-item">
				<img src="Images/scroll_img1.png" class="d-block w-100" alt="..." style="height:70vh">
			</div>
			<div class="carousel-item">
				<img src="Images/scroll_img3.png" class="d-block w-100" alt="..." style="height:70vh">
			</div>
		</div>
	...
	<div class="container-fluid py-3 px-3" style="background: black;">
...
<div class="container-fluid py-4" style="background-color: #343a40; color: white;">
    <div class="row">
        <div class="col-md-4 text-center">
            <h5>About Us</h5>
           <p>RevShop is your one-stop online store for the latest products and the hottest deals. We strive to bring you quality products at unbeatable prices, with exceptional customer service.</p>

        </div>
        <div class="col-md-4 text-center">
            <h5>Contact</h5>
            <p>Email: info@revshop.com</p>
            <p>Phone: +91-8825286836</p>
        </div>
        <div class="col-md-4 text-center">
            <h5>Follow Us</h5>
            <a href="#" style="color: white;">Facebook</a> |
            <a href="#" style="color: white;">Twitter</a> |
            <a href="https://www.instagram.com/itsprince_rajput_?utm_source=qr&igsh=dnk2Z211eHJsdzhh" style="color: white;">Instagram</a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col text-center">
